...
Route::get('/temp-db-import', function () {
    $path = database_path('data_import.sql');
    if (!file_exists($path)) {
    ...
    try {
        ...
        return "<h1>Database Import Successful!</h1><p>Data has been imported. You can now delete this route and the 'database/data_import.sql' file.</p><a href='/'>Go Home</a>";
    } catch (\Exception $e) {
